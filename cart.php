    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ?>
                                        <tr>
                                            ...
                                            <td class="product_thumb"><a href="productdetail.php?id=<?= $row["id"] ?>"><img
                                                        src="images/<?= $row["hinhanhsp"] ?>"
                                                        alt=""></a></td>
                                            <td class="product_name"><a href="productdetail.php?id=<?= $row["id"] ?>"><?= $row["tensp"] ?></a></td>
                                            <td class="product-price"><?= $row["giasp"] ?></td>
                                            <td class="product_quantity"><label></label> <input min="1"
                                                    max="100" value="1" type="number"></td>
                                            <td class="product_total"><?= $row["giasp"] ?></td>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="coupon_code left" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="coupon_inner">
                                <p>Nhập mã giảm giá để nhận ưu đãi</p>
                        ...
                        <div class="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="coupon_inner">
                                <div class="cart_subtotal">
                                    <p>Tổng chi phí</p>
                                    <p class="cart_amount">2500000 vnd</p>
                                </div>
                                <div class="cart_subtotal ">
                                    <p>Vận chuyển</p>
                                    <p class="cart_amount"><span></span> 200000 vnd</p>
                                </div>
                                    <p>Tổng</p>
                                    <p class="cart_amount">2700000 vnd</p>
                                </div>
                                <div class="checkout_btn">
                                    <a href="checkout.php" class="btn btn-md btn-golden">Thanh Toán</a>
                                </div>
                            </div>
                        </div>
                    </div>
