...
<body>
                            ...
                            <div class="main-menu menu-color--black menu-hover-color--golden">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="about-us.php">CỬA HÀNG</a>
                                        </li>
                                        <li>
                                            <a href="contact-us.php">LIÊN HỆ</a>
                                        </li>
                                        <li>
                                            <a href="contact-us.php">GIỚI THIỆU</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a >Chào mừng đến với trang đăng ký</a></li>
  ...
  if (isset($_POST['username'])) {
      ...
      if (empty($username) || empty($password) || empty($birthday) || empty($email)) {
          echo "<div class='form'><h3 class='h3'>Đăng ký không thành công.</h3><br/><a class='btn btn-md btn-black-default-hover' href='regist.php'>Đăng ký lại</a></div>";
      } else {
          $query = "INSERT into `users` (`username`, `password`, `email`, `sinhnhat`) VALUES ('$username', '$password', '$email', '$birthday')";
          $result = mysqli_query($con, $query);
  
          if ($result) {
              echo "<div class='form'><h3 class='h3'>Bạn đã đăng ký thành công</h3><br/><a class='btn btn-md btn-black-default-hover' href='login.php'>Đăng nhập</a></div>";
          }
      }
  } else {
      ?>
              ...
              <div class="row1">
                  <div class="col-lg-6 col-md-6">
                      <div class="account_form register" data-aos="fade-up" data-aos-delay="200">
                          <h3>Đăng ký</h3>
                          <h6>Nếu bạn là khách hàng mới</h6>
                          ...
                          <form method="POST" class="margin">
                              ...
                              <div class="save_button mt-3">
                                  ...
                                  <span><a href="login.php">Đăng nhập tại đây nếu đã có tài khoản</a></span>
                              </div>
                          </form>
                      </div>
                  </div>
  ...
  <?php } ?>
    ...
    margin-left: calc(var(--bs-gutter-x)/ -2);
        ...
        .h3{
            border-bottom:2px solid   #b19361;
        }
        .margin{
            margin-bottom:80px;
        }
