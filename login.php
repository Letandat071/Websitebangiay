...
<body>
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                            <nav aria-label="breadcrumb">
                                <ul>
                                    <li><a >Chào mừng đến với trang đăng nhập</a></li>
  ...
  require('db.php');
    ...
    $result = mysqli_query($con,$query) or die(mysqli_error($cons));
    $rows = mysqli_num_rows($result);
        if($rows==1){
      $_SESSION['username'] = $username;
      header("Location: index.php");
            }else{
        echo "<div class='form'><h3 class ='h3' >Tên đăng nhập hoặc mật khẩu không đúng!</h3></br><a class='btn btn-md btn-black-default-hover'  href='login.php'>Đăng nhập lại</a></div>";
        }
    }else{
?>
            ...
            <div class="row1">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="account_form" data-aos="fade-up" data-aos-delay="0">
                        <h3>Đăng nhập</h3>
                        <h6>Nếu đã có tài khoản</h6>
                        <form method="POST" name="login" class="margin">
