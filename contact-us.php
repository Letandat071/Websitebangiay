                ...
                <div class="col-12 d-flex align-items-center justify-content-between">
                    ...
                    <div class="mobile-right-side">
                        <ul class="header-action-link action-color--black action-hover-color--golden">
                            ...
                            <li>
                                <a href="wishtlist.php" class="offcanvas-toggle">
                                    <i class="icon-heart"></i>
                                    <span class="item-count">3</span>
                                </a>
                            </li>
            ...
            <div class="col-12">
                <div class="mapouter">
                    <div class="gmap_canvas">
                        <iframe id="gmap_canvas" src="" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            // Cập nhật đường dẫn iframe với vị trí hiện tại
            var iframe = document.getElementById('gmap_canvas');
            iframe.src = "https://maps.google.com/maps?q=" + latitude + "%2C" + longitude + "&t=&z=13&ie=UTF8&iwloc=&output=embed";
        });
    }
</script> <!-- ...::::End  Map Section:::... -->
                    ...
                    <div class="contact-details-wrapper section-top-gap-100" data-aos="fade-up" data-aos-delay="0">
                        <div class="contact-details">
                            ...
                            <div class="contact-details-single-item">
                                ...
                                <div class="contact-details-content contact-phone">
                                    <a href="mailto:demo@example.com">dat@vanlanguni.vn</a>
                                    <a href="http://www.example.com/">dat@vanlanguni.vn</a>
                                </div>
                            </div> <!-- End Contact Details Single Item -->
                            <!-- Start Contact Details Single Item -->
                            <div class="contact-details-single-item">
                                ...
                                <div class="contact-details-content contact-phone">
                                    <span>69/68 Đ.Đặng Thuỳ Trâm,Phường 13</span>
                                </div>
                            </div> <!-- End Contact Details Single Item -->
                        </div>
                    ...
                    <div class="contact-form section-top-gap-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form id="contact-form" action="https://htmlmail.hasthemes.com/nazmul/mail.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <a class="btn btn-lg btn-black-default-hover" href="mailto:mail@gmail.com" type="submit">SEND</a>
                                </div>
