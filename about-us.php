            ...
            <div class="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="200">
                        <h3 class="title">Giới Thiệu về chúng tôi</h3>
                        <h5 class="semi-title">Chúng tôi mang lại những giá trị tốt nhất dành cho bạn!.</h5>
                        <p>Chào mừng đến với Giày Nhanh - Địa chỉ trực tuyến cho tín đồ giày dép! 
                            Tại Giày Nhanh, chúng tôi mang đến cho bạn trải nghiệm mua sắm giày đa dạng, 
                            chất lượng và tiện lợi. Tận hưởng sự thoải mái, phong cách và dịch vụ giao hàng
                             nhanh chóng của chúng tôi. Khám phá Giày Nhanh ngay hôm nay và tạo phong cách 
                             riêng với đôi giày tuyệt vời của bạn.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up" data-aos-delay="0">
                        <h4 class="title">Dịch vụ tuyệt vời</h4>
                        <p>Ngoài ra, chúng tôi cũng mang đến cho bạn một trải nghiệm mua sắm trực tuyến dễ dàng và thuận tiện. Giao diện trực quan và dễ sử dụng của chúng tôi sẽ giúp bạn tìm thấy sản phẩm một cách nhanh chóng, và dịch vụ giao hàng nhanh chóng và tin cậy sẽ đưa đôi giày yêu thích của bạn đến tận cửa nhà.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="custom-progress m-t-40">
                        <div class="skill-progressbar" data-aos="fade-up" data-aos-delay="0">
                            <h6 class="font--semi-bold m-b-15">Nhanh chóng</h6>
                        ...
                        <div class="skill-progressbar" data-aos="fade-up" data-aos-delay="200">
                            <h6 class="font--semi-bold m-b-15">Tiện lợi</h6>
                        ...
                        <div class="skill-progressbar" data-aos="fade-up" data-aos-delay="400">
                            <h6 class="font--semi-bold m-b-15">An toàn</h6>
